...
| 문서 | 내용 |
|---|---|
| **[CLAUDE.md](CLAUDE.md)** | **유지보수 가이드 — 새 AI 세션/개발자가 가장 먼저 읽을 것** (규칙·레시피·배포) |
...
푸시하면 GitHub Pages에 자동 배포됩니다 — **https://qdwe93.github.io/korea_oc/**
※ 검수 전용입니다. 최종 목적지는 실제 호스팅(koreaoilchem.com)이며, 미리보기는 검색 색인이 차단되어 있습니다(robots.txt Disallow).
